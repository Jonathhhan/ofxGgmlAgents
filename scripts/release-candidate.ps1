...
try {
	...
	Assert-FileContains $releaseNotes "OFXGGML_AGENTS_VERSION_STRING.*1\.0\.1" "v1.0.1 release notes"
	Assert-FileContains $releaseNotes "does not include complete planner loops" "v1.0.1 release notes"
